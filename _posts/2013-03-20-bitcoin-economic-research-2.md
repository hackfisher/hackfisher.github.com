...
# 交易所和在线钱包的信用和被攻击风险
Bitcoin需要流通，尤其在初期支持的应用比较少的情况下，就需要与法定货币按照一定的汇率进行交换。而交易所就是一个交换Bitcoin的地方，在去中心化的系统中增加了一些相对中心化的组织，本身就增大了一些风险。事实上Mt.Gox就做过回滚交易的事情。[5]
...
1. 当人们预期价格下跌时，他们变得​​不太愿意花钱，尤其是不太愿意借钱。
2. 价格下跌加重债务人实际负​​担。
3. 在通货紧缩经济中，工资经常不得不下降，但实际上这在现实中是非常困难的。
...
1. 比特币网络对传统的货币体制构成威胁和驱逐，而政府恰恰是传统法定货币体制的最大收益者。 虽然我认为很大程度上两者会共存，但是信息充分的自由市场中，优币是会驱逐劣币的。Gresham's Law的所谓[劣币驱逐良币](http://baike.baidu.com/view/469869.htm)的理论是没有道理的，这个以后可能会做解释。

2. 比特币的匿名性，导致政府不喜欢，容易被用于非法交易中。

3. 比特币是P2P的，所以政府很难征税，而税收是政府的财务来源。

4. 很多政府存在汇率管制，并且法定货币是很多国家进行经济调控的手段。
...
1. 交易所和银行的中心化
2. 矿池的中心化
3. 开发者社区的中心化(相信3月12日事件，大家已经见识了core dev team的影响力)
